...
This report currently omits full anomaly-map interpolation and counterfactual
patch replacement; those are follow-up tasks in the PatchCore hero demo path.
