...
It writes ignored local files under `outputs/patchcore_logic/` and compares
local patch novelty with rule-level statements such as slot occupancy and
component identity. It remains a synthetic proxy until MVTec LOCO AD is sourced.
